...
import 'ui/pages/headphones_settings/anc_settings_page.dart';
import 'ui/pages/headphones_settings/connection_settings_page.dart';
import 'ui/pages/headphones_settings/eq_settings_page.dart';
import 'ui/pages/headphones_settings/gestures_settings_page.dart';
    ...
    return DynamicColorBuilder(
      builder: (lightDynamic, darkDynamic) => MaterialApp(
        ...
        routes: {
          ...
          '/headphones_settings/gestures_settings': (context) => const GesturesSettingsPage(),
          '/headphones_settings/connection_settings': (context) => const ConnectionSettingsPage(),
          '/headphones_settings/anc_settings': (context) => const AncSettingsPage(),
          '/headphones_settings/eq_settings': (context) => const EqSettingsPage(),
