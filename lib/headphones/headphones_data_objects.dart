...
class HeadphonesGestureSettings {
  ...
  final HeadphonesGestureTripleTap? tripleTapLeft;
  final HeadphonesGestureTripleTap? tripleTapRight;
  ...
  HeadphonesGestureSettings copyWith({
    ...
    HeadphonesGestureTripleTap? tripleTapLeft,
    HeadphonesGestureTripleTap? tripleTapRight,
...
enum HeadphonesGestureTripleTap {
  nothing(255), // should be -1 but our implementation doesn't see negative
  next(2),
  previous(7);
  ...
  const HeadphonesGestureTripleTap(this.mbbValue);

  static fromMbbValue(int mbbValue) => HeadphonesGestureTripleTap.values
      .firstWhere((e) => e.mbbValue == mbbValue);
}

enum HeadphonesAncType {
  general(0),
  cozy(1),
  ultra(2),
  dynamic(3);
  ...
  const HeadphonesAncType(this.mbbValue);

  static fromMbbValue(int mbbValue) => HeadphonesAncType.values
      .firstWhere((e) => e.mbbValue == mbbValue);
}

enum HeadphonesEqMode {
  nothing(1),
  bass(2),
  treble(3),
  voice(9);
  ...
  const HeadphonesEqMode(this.mbbValue);

  static fromMbbValue(int mbbValue) => HeadphonesEqMode.values
      .firstWhere((e) => e.mbbValue == mbbValue);
}
