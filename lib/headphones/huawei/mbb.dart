...
class MbbCommand {
  ...
  static const requestEq = MbbCommand(43, 74, {});
  static const requestAutoPause = MbbCommand(43, 17, {});
  static const requestDualConnect = MbbCommand(43, 47, {});
  static const requestLdacState = MbbCommand(43, 163, {});
  static const requestGestureDoubleTap = MbbCommand(1, 32, {});
  static const requestGestureTripleTap = MbbCommand(1, 38, {});
  static const requestGestureHold = MbbCommand(43, 23, {});
  static const requestGestureHoldToggledAncModes = MbbCommand(43, 25, {});
  static const requestSlide = MbbCommand(43, 31, {});
  ...
  static const ancDynamic = MbbCommand(43, 4, {
    1: [1, 3]
  });
  static const ancCozy = MbbCommand(43, 4, {
    1: [1, 1]
  });
  static const ancGeneral = MbbCommand(43, 4, {
    1: [1, 0]
  });
  static const ancUltra = MbbCommand(43, 4, {
    1: [1, 2]
  });

  static const voiceModeOff = MbbCommand(43, 4, {
    1: [2, 2]
  });
  static const voiceModeOn = MbbCommand(43, 4, {
    1: [2, 1]
  });
  
  //Connection settings
  static const dualConnectOff = MbbCommand(43, 46, {
    1: [0]
  });
  static const dualConnectOn = MbbCommand(43, 46, {
    1: [1]
  });

  static const ldacOff = MbbCommand(43, 162, { //hi-res audio
    1: [0]
  });
  static const ldacOn = MbbCommand(43, 162, {
    1: [1]
  });
  ...
  static gestureTripleTapLeft(HeadphonesGestureTripleTap left) =>
      MbbCommand(1, 37, {
        1: [left.mbbValue],
      });
  static gestureTripleTapRight(HeadphonesGestureTripleTap right) =>
      MbbCommand(1, 37, {
        2: [right.mbbValue],
      });
  static gestureHold(HeadphonesGestureHold gestureHold) => MbbCommand(43, 22, {
    1: [gestureHold.mbbValue],
    2: [gestureHold.mbbValue],
  });
  ...
  static const slideOn = MbbCommand(43, 30, {
    1: [0],
    2: [0]
  });
  static const slideOff = MbbCommand(43, 30, {
    1: [255],
    2: [255]
  });
  ...
  //Eq sets up
  static const eqNothing = MbbCommand(43, 73, {
    1: [1]
  });
  static const eqBass = MbbCommand(43, 73, {
    1: [2]
  });
  static const eqTreble = MbbCommand(43, 73, {
    1: [3]
  });
  static const eqVoice = MbbCommand(43, 73, {
    1: [9]
  });
